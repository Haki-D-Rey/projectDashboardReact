...
const BalanceTrading: NextPageWithLayout = () => {
                ...
                results: [
                    {
                        ...
                        product: 'Trading',
                        amount: '180$',
                        description: 'Trading - % ganancias Enero',
                    ...
                    },
                    {
                        ...
                        product: 'Trading',
                        amount: '180$',
                        description: 'Trading - 50% ganancias Enero',
                        related_balance_post_operation: '900$',
                    },
                ],
            },
    ...
    return (
        <div className="flex flex-col w-full items-center justify-center gap-3 md:gap-6">
            <div className="mt-5 flex w-full flex-row justify-center h-[45px] md:h-[54px]">
                <TitleUI
                    title={useMobile ? 'BALANCE DE COFUNDADOR TRADING PLANS' : "BALANCE DE COFUNDADOR / TRADING PLANS"}
                    urlImage={imageTitle}
                    transparent
                    onClickHandler={{
...
BalanceTrading.getLayout = function getLayout(page: ReactElement) {
    return <Layout>{page}</Layout>;
};

export default BalanceTrading;