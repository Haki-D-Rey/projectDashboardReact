...
const KitPlans: NextPageWithLayout = () => {
  ...
  const [table, setTable] = useState<ITableCustomUI>({
    ...
    urlImage: {
      path: '',
      src: '/assets/UI/iconBalanceKP.svg',
      style: {
        position: 'absolute',
        top: '50%',
        left: '50%',
  ...
  const arrayListButton: IButtonUI[] = [
    {
      ...
      onClickHanbdlerButtonUI: () => {
        router.push('/admin/kit-plans/new');
      },
...
KitPlans.getLayout = function getLayout(page: ReactElement) {
  return <Layout>{page}</Layout>;
};

export default KitPlans;
